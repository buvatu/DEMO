...
drop table if exists qlds.order_details;
...
drop table if exists qlds.order_change_history;
...
ALTER TABLE qlds.vcf ADD CONSTRAINT month_year_key UNIQUE (month, year);
