...
ALTER TABLE "EPSR"."MAINCOMP" ALTER COLUMN "LOADORDER" ADD GENERATED BY DEFAULT AS IDENTITY (START WITH 9 INCREMENT BY 1);
...
CREATE INDEX "DATAGROUPPATTERN_1" ON "EPSR"."DATAGROUPPATTERN" (
	"GROUPID"
);
...
CREATE INDEX PNPPATTERN_1 ON "EPSR"."PNPPATTERN" (
	"MAINID"
	);
...
CREATE INDEX PKGPATTERN_1 ON "EPSR"."PKGPATTERN" (
	"MAINID"
	);
...
ALTER TABLE "EPSR"."USERSESSION" ALTER COLUMN "USERSESSIONID" ADD GENERATED ALWAYS AS IDENTITY;
...
ALTER TABLE "EPSR"."PNPACTION" ALTER COLUMN "PNPACTIONID" ADD GENERATED ALWAYS AS IDENTITY;
CREATE INDEX PNPACTION_1 ON "EPSR"."PNPACTION" (
	"USERSESSIONID"
	);
...
ALTER TABLE "EPSR"."PKGACTION" ALTER COLUMN "PKGACTIONID" ADD GENERATED ALWAYS AS IDENTITY;
CREATE INDEX PKGACTION_1 ON "EPSR"."PKGACTION" (
	"USERSESSIONID"
	);

-- USERACCESSGROUPMNGMENTRY
...
CREATE INDEX MAIN_TSM_1 ON "EPSR"."MAIN_TSM" (
	"MAINID", "TSMID"
	);
...
CREATE INDEX PNP_PNPFILE_1 ON "EPSR"."PNP_PNPFILE" (
	"TT", "HLQ", "MK", "PN", "EC"
	);
CREATE INDEX PNP_PNPFILE_2 ON "EPSR"."PNP_PNPFILE" (
...
CREATE TABLE "EPSR"."PKG_PNPFILE" (
	...
	FOREIGN KEY ("FILENAME", "FILELOCATION") REFERENCES "EPSR"."PNPFILE" ("FILENAME", "FILELOCATION") ON DELETE CASCADE ON UPDATE NO ACTION);
CREATE INDEX PKG_PNPFILE_1 ON "EPSR"."PKG_PNPFILE" (
	"TT", "HLQ", "MK", "PN", "PKG", "EC"
	);
CREATE INDEX PKG_PNPFILE_2 ON "EPSR"."PKG_PNPFILE" (
	"FILENAME", "FILELOCATION"
	);
...
CREATE INDEX PNP_PKG_1 ON "EPSR"."PNP_PKG" (
...
CREATE INDEX PKG_PKG_1 ON "EPSR"."PKG_PKG" (
...
CREATE INDEX PNPREVISION_1 ON "EPSR"."PNPREVISION" (
	"BASETT", "BASEHLQ", "BASEMK", "BASEPN", "BASEEC"
	);
CREATE INDEX PNPREVISION_2 ON "EPSR"."PNPREVISION" (
...
CREATE INDEX PKGREVISION_1 ON "EPSR"."PKGREVISION" (
	"BASETT", "BASEHLQ", "BASEMK", "BASEPN", "BASEPKG", "BASEEC"
	);

CREATE INDEX PKGREVISION_2 ON "EPSR"."PKGREVISION" (
...
CREATE TABLE "EPSR"."USER" (
	...
	"AUTHORITIES" INTEGER NOT NULL DEFAULT 0, 
	"LDAPSTATUS" INTEGER NOT NULL DEFAULT 1, 
