...
public class MainController {
    ...
    public ResponseEntity<?> getOrderDetails(@RequestParam(required = false, defaultValue = "active") String status) {
        return ResponseEntity.ok(mainService.getOrderDetails(status));
    }
